...
import { Staking721New } from "contracts/extension/Staking721New.sol";
...
contract MyStakingContractNew is ERC20, Staking721New, IERC721Receiver {
    bool condition;
    ...
    ) ERC20(_name, _symbol) Staking721New(_nftCollection) {
        condition = true;
...
contract StakingExtensionTestNew is DSTest, Test {
    MyStakingContractNew internal ext;
    ...
    function test_revert_stake_stakingZeroTokens() public {
        ...
        vm.prank(stakerOne);
        vm.expectRevert(abi.encodeWithSignature("StakingZeroTokens()"));
        ext.stake(_tokenIds);
    }
    ...
    function test_revert_withdraw_withdrawingZeroTokens() public {
        ...
        vm.expectRevert(abi.encodeWithSignature("WithdrawingZeroTokens()"));
        ext.withdraw(_tokensToWithdraw);
    }
    ...
    function test_revert_withdraw_notStaker() public {
        ...
        vm.prank(stakerOne);
        vm.expectRevert(abi.encodeWithSignature("NotStaker()"));
        ext.withdraw(_tokensToWithdraw);
    }
    ...
    function test_revert_withdraw_withdrawingMoreThanStaked() public {
        ...
        vm.prank(stakerOne);
        vm.expectRevert(abi.encodeWithSignature("WithdrawingMoreThanStaked()"));
        ext.withdraw(_tokensToWithdraw);
    }
}
